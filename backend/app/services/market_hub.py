        ...
        recommendation_signature = json.dumps(
            {
                ...
                "primary_play": (recommendation.get("primary_play") or {}).get("full_label"),
                "stake_level": (recommendation.get("stake_plan") or {}).get("level"),
                "stake_units": (recommendation.get("stake_plan") or {}).get("units"),
            },
            ensure_ascii=False,
            sort_keys=True,
        )
